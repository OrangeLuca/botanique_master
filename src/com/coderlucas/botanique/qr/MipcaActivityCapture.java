package com.coderlucas.botanique.qr;
...
import com.coderlucas.botanique.HeadBar;
import com.coderlucas.botanique.Keys;
import com.coderlucas.botanique.R;
import com.coderlucas.botanique.SearchClassifyInfoActivity;
...
public class MipcaActivityCapture extends Activity implements Callback
{
	...
	public void onCreate(Bundle savedInstanceState)
	{
		...
		HeadBar mHeadBar = (HeadBar) findViewById(R.id.qrcode_headbar);
		mHeadBar.setImageResource(R.drawable.headbar_back);
		mHeadBar.setTextTitleResource(getString(R.string.text_qrcode_title));
	...
	public void handleDecode(Result result, Bitmap barcode)
	{
		...
		else
		{
			...
			resultIntent.setClass(getApplicationContext(),
					SearchClassifyInfoActivity.class);
			Bundle bundle = new Bundle();
			bundle.putString("SearchClassifyInfoKey", _ClassifyId);
