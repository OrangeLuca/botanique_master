...
public class MenuItemAccount extends RelativeLayout
{
	private ImageView mImageView;
	private TextView mTextViewTitle;
	private TextView mTextViewInfo;
	
	public MenuItemAccount(Context context)
	{
		super(context);
	}
	
	public MenuItemAccount(Context context, AttributeSet attrs)
	{
		super(context, attrs);
		...
		_LayoutInflater.inflate(R.layout.menu_item_account, this);
		...
		mTextViewInfo = (TextView)findViewById(R.id.item_info);
	...
	public void setTextInfoResource(String text)
	{
		mTextViewInfo.setText(text);	
	}
	
	public void setMenuItemAccountOnClickListener(View v, OnClickListener listener)
	{
		...
		if (v instanceof ViewGroup)
		{
			...
			for (int i = 0; i < count; i++)
			{
				...
				{
					setMenuItemAccountOnClickListener(child, listener);
				}
